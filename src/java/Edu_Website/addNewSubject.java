...
@WebServlet(urlPatterns = {"/addNewSubject"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try{
                ...
                String supervisorId = session.getAttribute("G-userId").toString();
                int year = Integer.parseInt(request.getParameter("subject-year"));

                subject.add_new_subject(name, code, pass, year, supervisorId);
                
                noti.insert_notification(name + " has been Added", supervisorId);
