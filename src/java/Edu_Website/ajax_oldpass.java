...
@WebServlet(name = "ajax_oldpass", urlPatterns = {"/ajax_oldpass"})
public class ajax_oldpass extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ajax_oldpass.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
